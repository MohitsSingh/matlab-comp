...
number_snapshots = 1800;                     %here to modify the samples
...
fprintf('\n Finished calculating, plotting.......!\n')
 if ii==1
        subplot(2,1,ii),drawF(xPixels,yPixels,SNR_CoMP_ISD1,SNR_hard_ISD1,number_comp_cells,resolution);
 else
        subplot(2,1,ii),drawF(xPixels,yPixels,SNR_CoMP_ISD2,SNR_hard_ISD1,number_comp_cells,resolution);
 end
